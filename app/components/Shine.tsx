...
// from https://codesandbox.io/p/sandbox/shine-effect-pvyr2j?file=%2Fsrc%2FApp.tsx%3A11%2C1-12%2C1
export const Shine = ({
  children,
  lightColor = "#666666",
  puffyness = "1",
  ...
  return (
    <div className={cn("relative select-none", className)} {...otherProps}>
      <svg
        width="0"
        height="0"
